...
public class TagAPI_3 {
    ...
    private static void execute_modded_mc(String VersionToUse_, String OperatingSystemToUse_, String UsernameToUse_) {
        ...
        String inheritsFrom = local.readJson_inheritsFrom(utils.getMineCraft_Version_Json(OperatingSystemToUse, VersionToUse));
        System.out.println(inheritsFrom);
        
        if (inheritsFrom.equals("N/A")) {
            //nothing to get.. just launch the thing. but check for java..
        } else {

            
            VersionToUse = inheritsFrom;
